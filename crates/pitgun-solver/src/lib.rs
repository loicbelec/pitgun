...
pub fn start_authorized_dynamic_racing_session_with_catalog_json(
    ...
    pitgun_racing_simulator::start_authorized_dynamic_racing_session_with_catalog_json(
        request_json,
        catalog_bundle_json,
    )
}
...
pub fn pull_authorized_dynamic_racing_session_json(handle: u32) -> String {
    pitgun_racing_simulator::pull_authorized_dynamic_racing_session_json(handle)
}
...
pub fn complete_authorized_dynamic_racing_session_json(handle: u32) -> String {
    pitgun_racing_simulator::complete_authorized_dynamic_racing_session_json(handle)
}
...
pub fn release_authorized_dynamic_racing_session_json(handle: u32) -> String {
    pitgun_racing_simulator::release_authorized_dynamic_racing_session_json(handle)
}
